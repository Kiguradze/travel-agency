  ...
  return (
    ...
    >
      <div className="w-full h-full bg-black/40 md:rounded-[24px] ">
        <Nav />
        <div className="mt-[54px] items-center text-white text-center relative">
          <h2 className="text-[36px] md:text-[45px] font-[700]">
            Helping Others
          </h2>
          <h1 className="text-[48px] md:text-[80px] font-[700] uppercase">
            Live & Travel
          </h1>
